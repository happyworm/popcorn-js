...
asyncTest( "Player external jQuery and jPlayer load. Done once here, otherwise multiple jQuery instances screw everything up.", function() {
	...
	pop1 = Popcorn.jplayer( "#video5", "http://www.jplayer.org/video/m4v/Big_Buck_Bunny_Trailer.m4v" );

	pop1.on( "loadstart", function() {
		alert( 'loadstart' );
		equal( pop1.media.paused, true, "(popcorn 1 paused by default) The loadstart event is the only universal way to know jPlayer is ready for these tests." );
		plus();
		// pop1.play();
		setTimeout(function() {
			pop1.play();
	...
	pop1.on( "error", function() {
		alert( 'error.code: ' + pop1.media.error.code + '| error.type: ' + pop1.media.error.type);
	});
});

/*

// Letting this next test run killed Firefox. Not sure what is wrong atm. Got too much recursion.
// However, that did not explain why this 2nd set of tests run in parallel the 1st set did!
// Plus the first time it loaded in the page it would work as expect, which 2 fails, but it did not kill the browser!
...
asyncTest( "Player play, pause, autoplay", function() {
	...
	var count = 0,
			...
			orderCheck2 = 0,
			pop1, pop2, pop3, pop4,
			first1 = true, first2 = true, first3 = true, first4 = true;
	...
	pop1 = Popcorn.jplayer( "#video6", "http://www.jplayer.org/video/m4v/Big_Buck_Bunny_Trailer.m4v" );
	...
	pop2 = Popcorn.jplayer( "#video7", "http://www.jplayer.org/video/m4v/Big_Buck_Bunny_Trailer.m4v" );

	pop2.on( "loadstart", function() {
	...
	pop3 = Popcorn.jplayer( "#video8", "http://www.jplayer.org/video/m4v/Big_Buck_Bunny_Trailer.m4v" );

	pop3.on( "loadstart", function() {
	...
	pop4 = Popcorn.jplayer( "#video9", "http://www.jplayer.org/video/m4v/Big_Buck_Bunny_Trailer.m4v" );
	pop4.autoplay(true);

	pop4.on( "loadstart", function() {
